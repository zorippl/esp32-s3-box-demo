...
#define  SR_EVENT_WAKE_UP       BIT(0)
#define  SR_EVENT_WORD_DETECT   BIT(1)
#define  SR_EVENT_TIMEOUT       BIT(2)
#define  SR_EVENT_ALL           (BIT(0) | BIT(1) | BIT(2))
...
/**
 * @brief Set date text of clock page
 *
 * @param text String of current date. Should be static.
 */
void ui_clock_set_date(char *text);
