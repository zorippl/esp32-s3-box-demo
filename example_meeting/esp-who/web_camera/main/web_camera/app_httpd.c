...
static esp_err_t cmd_handler(httpd_req_t *req)
{
    ...
    if (!strcmp(variable, "framesize")) {
        ...
        // } else 
        {
            extern esp_err_t init_camera(uint32_t xclk_freq_hz, pixformat_t pixel_format, framesize_t framesize, uint8_t fb_count);
            ...
            init_camera(freq, pixel_format, (framesize_t)val, 1);
