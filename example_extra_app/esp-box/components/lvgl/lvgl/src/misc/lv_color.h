...
{
    return lv_color_make(0x87, 0xce, 0xfa);
}
static inline lv_color_t lv_color_tomato(void)
{
    return lv_color_make(0xff, 0x6a, 0x6a);
}
static inline lv_color_t lv_color_turquoise(void)
{
    return lv_color_make(0x40, 0xe0, 0xd0);
}
