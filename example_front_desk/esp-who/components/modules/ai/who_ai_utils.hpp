 ...
 * @param image_width       width of image
 * @param results           detection results
 * @param detected_counts   detected counts
 */
void draw_detection_result_my(uint16_t *image_ptr, int image_height, int image_width, std::list<dl::detect::result_t> &results);